        ...
        HStack(spacing: 4) {
            ...
            Button { commit() } label: {
                Image(systemName: "checkmark")
                    ...
                    .foregroundStyle(draftText.isEmpty ? Theme.tertiary : Theme.ink)
    ...
    var body: some View {
        HStack(spacing: editing ? 6 : 9) {
            if !editing {
                ...
                .font(.system(size: 10, weight: .medium))
                    .foregroundStyle(justCopied ? Theme.ink : Theme.tertiary)
                    .frame(width: 14)
            }
            ...
            if editing {
                ...
                SpoilerText(
                    ...
                    hidden: hidden,
                    color: item.label.isEmpty ? Theme.ink : Theme.secondary,
