...
struct ShelfPane: View {
    ...
    private var dropHint: some View {
        RoundedRectangle(cornerRadius: 14, style: .continuous)
            .strokeBorder(
                isTargeted ? Theme.ink.opacity(0.6) : Theme.hairline,
            ...
            .overlay(
                Image(systemName: "tray.and.arrow.down.fill")
                    ...
                    .foregroundStyle(isTargeted ? Theme.ink : Theme.tertiary)
            )
            .frame(maxWidth: .infinity, maxHeight: .infinity, alignment: .top)
    ...
    var body: some View {
        ...
        .background(
            RoundedRectangle(cornerRadius: 12, style: .continuous)
                .fill(isSelected ? Theme.ink.opacity(0.18) : (isHovered ? Theme.surfaceHover : Theme.surface))
        )
        .overlay(
            RoundedRectangle(cornerRadius: 12, style: .continuous)
                .strokeBorder(Theme.ink.opacity(isSelected ? 0.55 : 0), lineWidth: 1.5)
